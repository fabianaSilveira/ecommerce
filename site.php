...
$app->get("/cart/:idproduct/add", function ($idproduct) {
	...
	//recupera o cart da sessão ou cria
	$cart = Cart::getFromSession();
...
//diminui a qtde do produto no cart
...
//remove todos o prutudo do cart
...
//chamado ao clicar "finalizar compra' => http://localhost/ecommerce/cart
//chamado ao clicka "Atualizar CEP" => http://localhost/ecommerce/checkout?zipcode=&proceed=Finalizar+Compra
...
/* 	var_dump($_GET['zipcode']);
	exit;

	*/
//echo "zipcod01".$_GET['zipcode'];

	if (!isset($_GET['zipcode'])  ||
        (isset($_GET['zipcode']) && !$_GET['zipcode'])) {
...
//chamado ao clicar "continuar" => http://localhost/ecommerce/checkout?zipcode=&proceed=Finalizar+Compra
...
//chamado pelo clique no bt "impirimir boleto" profile_order.html =>
//minha conta -> meus pedidos bt detalhe de um pedido
